---
title: "Docker : un gestionnaire de process"
weight: 4
---
...
**Vous avez vu que le(s) conteneur(s) Docker que vous avez lancé avec Portainer sont des processus visibles dans votre système.**

Focalisons-nous sur cette approche par les process.

---

### Lancer une commande listant les instances Docker

**La commande suivante permet d'afficher la liste des conteneurs en cours d'exécurition sur la machine.**
...
Cette commande liste les conteneurs actifs, on peut également vouloir lister les conteneurs inactifs. 

Dans ce cas on lancera :
...
**On va maintenant Appeler un terminal et entrer la commande `ps` suivante.**
