---
title: Packager son application (helm, kustomize)
draft: false
---

## Packager son application (helm, kustomize)

Comment fournir une méthode standard pour distribuer les manifestes d'une application ?
