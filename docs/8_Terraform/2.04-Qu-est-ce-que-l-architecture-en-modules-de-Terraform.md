...
**HashiCorp recommande fortement que chaque module suive certaines conventions de code connues sous le nom de [structure de module standard](www.terraform.io/docs/modules/index.html#standard-module-structure).** 
