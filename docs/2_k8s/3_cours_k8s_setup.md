---
title: 3 - Architecture de Kubernetes et les différents types de clusters
draft: false
sidebar_position: 7
---
...
**Pour sa qualité on recommande parfois Google GKE qui est plus ancien.** 

Mais comme les gros fournisseur proposent des services éprouvés, il s'agit surtout de faciliter l'intégration avec l'existant:
...
Mais àa encore il s'agit de ne pas sous-estimer la complexité de la maintenance (comme avec kubeadm).
