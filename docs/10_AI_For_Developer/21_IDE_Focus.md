...
|:-------------------:|:------------:|:------------------------:|:---------:|:-----------:|:----------------------------------------------:|
|    Copilot (MS)     | Propriétaire |    Oui (commerciaux)     |     1     | plugin, web |     [[>]](https://copilot.microsoft.com/)      |
| CodeWhisperer (AWS) | Propriétaire |    Non (commerciaux)     |     1     | plugin, cli | [[>]](https://aws.amazon.com/fr/q/developer/)  | 
|       Tabnine       |     Open     | Oui (commerciaux/libres) |     3     |     plugin     | [[>]](https://www.tabnine.com/)  |
|       Cursor        | Propriétaire |    Oui (commerciaux)     |     2     |     IDE     | [[>]](https://www.cursor.com/)  |
